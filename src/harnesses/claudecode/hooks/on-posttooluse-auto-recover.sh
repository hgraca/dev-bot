#!/usr/bin/env bash
# =============================================================================
# src/harnesses/claudecode/hooks/on-posttooluse-auto-recover.sh
# Claude Code PostToolUse hook — detects transient errors in tool output and
# writes a trigger file for the Stop hook to pick up.
#
