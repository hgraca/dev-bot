...
description: "Use when splitting accumulated changes into commits. Triggers on 'commit my changes', 'split this up', 'make atomic commits', 'clean up before the PR'."
---
