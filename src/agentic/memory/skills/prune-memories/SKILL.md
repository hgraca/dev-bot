...
- User says "prune memories", "clean up memories", or invokes `/devbot:prune-memories`
- Vault noisy after many sessions
- Major project milestone — old decisions superseded

## Before Starting

Load the `devbot:memory-management` context skill once. Provides frontmatter schema, routing table, quality criteria used throughout.
...
Apply `devbot:memory-management` skill section 7:
