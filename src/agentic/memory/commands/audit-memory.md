...
Deep structural audit of `.agents/memory/`. Fix fixable; flag what needs user input. For vault structure, routing, and quality rules, load `memory-management` skill.
