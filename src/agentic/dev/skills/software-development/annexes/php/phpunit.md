---
name: phpunit
description: "PHPUnit conventions: test attributes, avoiding risky/slow warnings, handler cleanup, slow test detector, e2e testing pattern for framework-agnostic libraries. Read this annex when writing or reviewing PHPUnit tests."
---
...
This file is an annex of the `devbot:software-development` hub. Read it only when writing or reviewing PHPUnit tests. For generic craft — code-quality principles, tests-first discipline, test craft, commit protocol — see `devbot:software-development`.
...
- `devbot:make-tests` skill — project-wide test strategy, commands, conventions
- `annexes/php/message-bus.md` — message bus handler testing patterns
- `annexes/php/php-rules.md` — PHP coding conventions
