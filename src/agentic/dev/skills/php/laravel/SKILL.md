---
name: laravel
description: "Laravel conventions: project structure (Laravel 10), configuration, Eloquent, controllers, validation, authentication, Artisan commands, testing. Use this skill whenever writing Laravel application code, working with Eloquent models, creating controllers, or running Artisan commands — even if you do not name Laravel explicitly."
---
