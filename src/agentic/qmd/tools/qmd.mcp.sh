...
# ---
# =============================================================================
# src/agentic/qmd/tools/qmd.mcp.sh
...
#
# Usage:
#   qmd.mcp.sh status                  # Show QMD health and collections
#   qmd.mcp.sh query "question"        # Search with auto-expand + rerank
#   qmd.mcp.sh search "keywords"       # BM25-only search
#   qmd.mcp.sh get "#docid"            # Retrieve doc by ID
#   qmd.mcp.sh multi-get "glob"        # Retrieve multiple docs
#   qmd.mcp.sh update                  # Update index
#   qmd.mcp.sh embed                   # Run embedding
#   qmd.mcp.sh collection add ...      # Manage collections
#   qmd.mcp.sh context add ...         # Manage context entries
#   echo "query" | qmd.mcp.sh          # Pipe mode: stdin -> qmd
#   qmd.mcp.sh --help                  # Show usage
# =============================================================================
...
if [[ "${1:-}" == "--help" ]] || [[ "${1:-}" == "-h" ]]; then
  echo "Usage: qmd.mcp.sh [options] [command] [args...]"
  echo ""
  ...
  echo ""
  echo "Pipe mode:"
  echo "  echo \"query\" | qmd.mcp.sh    Query from stdin"
  echo ""
  echo "Output:"
  echo "  ## QMD output"
  echo ""
