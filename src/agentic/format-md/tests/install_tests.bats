#!/usr/bin/env bats
# =============================================================================
# src/agentic/format-md/tests/install_tests.bats
# Tests for src/agentic/format-md/install.sh — verifies the prettier guard
...
setup() {
  ...
  INSTALL_SH="${PROJECT_ROOT}/src/agentic/format-md/install.sh"
}
