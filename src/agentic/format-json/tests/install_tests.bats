#!/usr/bin/env bats
# =============================================================================
# src/agentic/format-json/tests/install_tests.bats
# Tests for src/agentic/format-json/install.sh — verifies the prettier guard
...
setup() {
  ...
  INSTALL_SH="${PROJECT_ROOT}/src/agentic/format-json/install.sh"
}
