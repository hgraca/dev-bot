...
Reference implementation: `src/instructions/tools/tree/` (`tree.ts` + `tree.mcp.sh`) — note this may still follow the legacy T→bash pattern; new tools MUST follow the TS-as-source-of-truth pattern above.
