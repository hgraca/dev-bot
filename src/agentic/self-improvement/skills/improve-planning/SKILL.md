...
Write `iteration-<n>/quality-report.md` following Plan Quality Report Guide below. Grades **absolute** — measured against reference standards (architecture rules, `plan` and `devbot:make-plan` skills, coding standards), not relative to any prior iteration.
