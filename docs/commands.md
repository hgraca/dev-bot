...
| signoz  | find-db-performance-issues | Find database issues (full table scans, slow queries, N+1, app anti-patterns, lock contention, hardware limitations) driving DB load, using SigNoz |
