...
| git                 | 6   | 3   | —   | —   | —   | Git workflow skills (atomic/conventional/fixup commits, advanced history surgery, git-report, release changelog) + git-report and release tools                                                                                                                                          |
| github              | —   | —   | —   | —   | —   | GitHub integration: gh-address-review and gh-make-review commands + GitHub CLI (gh) install/update lifecycle scripts                                                                                                                                                                     |
