...
Used by the harness resolution helpers (`_devbot_get_harness`, `_devbot_resolve_harness_bin`).
...
- `src/tools/devbot/init.sh` — Writes the default project config
